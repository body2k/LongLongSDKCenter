...
import com.longlong.common.node.ForestNodeManager;
import com.longlong.common.node.INode;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import com.longlong.common.support.IMultiOutputStream;
import com.longlong.common.support.ImagePosition;
...
public final class ImageUtil {
	 ...
	 * @param alpha    透明度：alpha 必须是范围 [0.0, 1.0] 之内（包含边界值）的一个浮点数字
	 */
	public static <T extends INode> java.util.List<T> mergeString(List<T> items) {
